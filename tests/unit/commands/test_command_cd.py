...
class TestCdCommand:
    ...
    def test_cd_too_many_args(self, shell_with_commands):
        """Cd with more than one argument returns INVALID_ARGUMENT."""
        result = shell_with_commands.execute("cd /etc /tmp")
